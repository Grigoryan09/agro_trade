...
public class MediaV1Endpoint implements MediaV1API {
    ...
    @Override
    public MediaResponse uploadImages(long userId, EntityType entityType, long entityId, List<MultipartFile> files) {
        return new MediaResponse(mediaService.saveMultipleMedia(files, entityId, entityType, userId));
    }
}
